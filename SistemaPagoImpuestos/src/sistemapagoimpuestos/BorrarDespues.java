 ...
 * @author vande
 */
public class BorrarDespues extends javax.swing.JFrame {

    /**
     * Creates new form BorrarDespues
     */
    public BorrarDespues() {
        initComponents();
    }
...
ControladorGestionarLiquidacion controlador = new ControladorGestionarLiquidacion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarDespues.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarDespues().setVisible(true);
            }
        });
    }
