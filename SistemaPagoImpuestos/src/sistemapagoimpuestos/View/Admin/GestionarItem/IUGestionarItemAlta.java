...
public class IUGestionarItemAlta extends javax.swing.JFrame {
    ...
    private void button_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_crearActionPerformed
        // TODO add your handling code here:
        try {
            if(textfield_codigo.getText().isEmpty()||textfield_nombre.getText().isEmpty()||textfield_longitud.getText().isEmpty()){
                throw new ExcepcionGenerica("Los campos Codigo, Nombre y Longitud Item son requeridos");
            }
