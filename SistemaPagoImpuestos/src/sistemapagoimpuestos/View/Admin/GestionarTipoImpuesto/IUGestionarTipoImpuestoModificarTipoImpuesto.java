...
public class IUGestionarTipoImpuestoModificarTipoImpuesto extends javax.swing.JFrame {
    ...
    public IUGestionarTipoImpuestoModificarTipoImpuesto(String nombreTI, String cuitEmpresa) {
    ...
    private void button_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_modificarActionPerformed
        ...
        if(cuitEmpresa==null){
            ...
            controlador.modificarTipoImpuesto(textfield_nombre.getText(), nombreTI, checkbox_esEditable.isSelected(), checkbox_habilitado.isSelected());
            this.dispose();
            controlador.iniciar();
