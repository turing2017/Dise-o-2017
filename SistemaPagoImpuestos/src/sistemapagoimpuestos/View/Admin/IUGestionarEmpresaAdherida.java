    ...
    //Mostrar la pantalla correspondiente a la opcion seleccionada
        ...
        public void obtenerEmpresas(){
           ...
           for (DTOEmpresa dtoEmpresa : listDtoEmpresa) {
            ...
            vect.add(dtoEmpresa.getCuitDTOEmpresa());
            vect.add(dtoEmpresa.getNombreDTOEmpresa());
            vect.add(dtoEmpresa.getDireccionDTOEmpresa());
            vect.add(dtoEmpresa.getNombreTipoEmpresaDTOEmpresa());
               SimpleDateFormat sdf= new SimpleDateFormat("dd/MM/yyyy");
            if (dtoEmpresa.getFechaHoraInhabilitacionDTOEmpresa() != null) {
                vect.add(sdf.format(dtoEmpresa.getFechaHoraInhabilitacionDTOEmpresa()));
            } else {
                vect.add("");
            }
            dtm.addRow(vect);
