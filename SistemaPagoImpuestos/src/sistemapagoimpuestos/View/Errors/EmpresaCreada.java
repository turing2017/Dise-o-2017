 ...
 */
public class EmpresaCreada extends javax.swing.JFrame {

    /**
     * Creates new form EmpresaCreada
     */
    public EmpresaCreada() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpresaCreada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpresaCreada().setVisible(true);
            }
        });
