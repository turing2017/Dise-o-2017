 ...
 * @author Dario
 */
public class ParametroCalculoEditableModificado extends javax.swing.JFrame {

    /**
     * Creates new form ModificacionExito
     */
    public ParametroCalculoEditableModificado() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParametroCalculoEditableModificado().setVisible(true);
            }
        });
