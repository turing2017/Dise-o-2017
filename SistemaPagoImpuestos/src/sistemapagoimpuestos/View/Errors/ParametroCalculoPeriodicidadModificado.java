 ...
 * @author Dario
 */
public class ParametroCalculoPeriodicidadModificado extends javax.swing.JFrame {

    /**
     * Creates new form ModificacionExito
     */
    public ParametroCalculoPeriodicidadModificado() {
        initComponents();
    ...
    private void button_aceptarKeyTyped(java.awt.event.KeyEvent evt) {                                        
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParametroCalculoPeriodicidadModificado().setVisible(true);
            }
        });
